...
//                                System.out.println(skill);
                ...
                for (int x = 1; x <= cols.size(); x++) {
                    int size = driver.findElements(By.xpath("//table[2]/tbody/tr/td[" + x + "]/dl/dt")).size();
                    for (int y = 1; y <= size; y++) {
                        String colHeadXpath = "//table[2]/tbody/tr/td[" + x + "]/dl[" + y + "]/dt";
                        String colDataXpath = "//table[2]/tbody/tr/td[" + x + "]/dl[" + y + "]/dt/following-sibling::dd";
